...
from main.database import create_tables, add_goal, get_goals, get_goal_by_id, update_goal, delete_goal, get_completed_tasks, update_goal_status
...
class GoalTrackingApp:
    ...
    def load_goals(self):
        ...
        goals = get_goals()
        for goal in goals:
            self.goal_listbox.insert(tk.END, f"{goal[0]} | {goal[1]} | Deadline: {goal[2]}")
